...
import com.amm.ecom.store.domain.ProductOrder;
import com.amm.ecom.store.service.ProductOrderService;
...
/**
 * REST controller for managing {@link com.amm.ecom.store.domain.ProductOrder}.
 */
@RestController
@RequestMapping("/api")
